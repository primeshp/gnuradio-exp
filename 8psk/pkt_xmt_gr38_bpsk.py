...
class pkt_xmt_gr38_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "pkt_xmt_gr38_bpsk")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pkt_xmt_gr38_bpsk")
        ...
        # Blocks
        ##################################################
        self._msg_tool_bar = Qt.QToolBar(self)
        self._msg_tool_bar.addWidget(Qt.QLabel('Message to Send' + ": "))
        self._msg_line_edit = Qt.QLineEdit(str(self.msg))
        self._msg_tool_bar.addWidget(self._msg_line_edit)
        self._msg_line_edit.returnPressed.connect(
            lambda: self.set_msg(str(str(self._msg_line_edit.text()))))
        self.top_grid_layout.addWidget(self._msg_tool_bar)
        ...
        self.uhd_usrp_sink_0.set_center_freq(433.4e6, 0)
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            verbose=False,
            log=False)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, usrp_rate,True)
        self.blocks_pdu_to_tagged_stream_0 = blocks.pdu_to_tagged_stream(blocks.byte_t, 'packet_len')
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.5)
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.cons(pmt.PMT_NIL,pmt.init_u8vector(9,[71,78,85,32,82,97,100,105,111])), 100)
    ...
    def set_msg(self, msg):
        self.msg = msg
        Qt.QMetaObject.invokeMethod(self._msg_line_edit, "setText", Qt.Q_ARG("QString", str(self.msg)))
