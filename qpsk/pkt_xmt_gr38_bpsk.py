...
class pkt_xmt_gr38_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.cons(pmt.PMT_NIL,pmt.init_u8vector(9,[71,78,85,32,82,97,100,105,111])), 1000)
        ...
        self.connect((self.mmse_resampler_xx_0, 0), (self.qtgui_const_sink_x_0, 0))
