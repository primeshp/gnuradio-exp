...
# Title: qpsk_pkt_rcv_gr38
# Author: Barry Duggan
# Description: QPSK packet receive (for GNURadio 3.8)
...
class qpsk_pkt_rcv_gr38(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_pkt_rcv_gr38")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_pkt_rcv_gr38")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_pkt_rcv_gr38")
        ...
        self.taps = taps =  firdes.complex_band_pass(1, usrp_rate, -usrp_rate/(2*20), usrp_rate/(2*20), 5000)
        self.sps = sps = 2
        ...
        self.osmosdr_source_1.set_sample_rate(usrp_rate)
        self.osmosdr_source_1.set_center_freq(433.4e6, 0)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self._gain_range = Range(0, 5, 0.1, 1, 200)
        ...
        self.digital_lms_dd_equalizer_cc_0 = digital.lms_dd_equalizer_cc(15, 0.001, 1, qpsk)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_tagged_stream_to_pdu_0, 'pdus'), (self.blocks_message_debug_1, 'print_pdu'))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.set_taps( firdes.complex_band_pass(1, self.usrp_rate, -self.usrp_rate/(2*20), self.usrp_rate/(2*20), 5000))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.usrp_rate, 50000, 10000, firdes.WIN_HAMMING, 6.76))
        self.osmosdr_source_1.set_sample_rate(self.usrp_rate)
...
def main(top_block_cls=qpsk_pkt_rcv_gr38, options=None):
