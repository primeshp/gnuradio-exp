...
class pkt_rcv_gr38(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(phase_bw, order, True)
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_bb("11100001010110101110100010010011", 1, 'start')
        ...
        self.connect((self.digital_correlate_access_code_tag_xx_0, 0), (self.blocks_repack_bits_bb_1, 0))
        ...
        self.connect((self.digital_map_bb_0, 0), (self.digital_correlate_access_code_tag_xx_0, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.usrp_rate, 65000, 5000, firdes.WIN_HAMMING, 6.76))
